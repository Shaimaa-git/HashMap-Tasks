...
public class StudentHashMapValueExistence {
    public static void main(String[] args) {
        ...
        // Check if a particular student name is present
        String searchName = "Noura";
        ...
        // Print the result
        System.out.println("Is \"" + searchName + "\" present in the HashMap? " + isNamePresent);
    }
}
