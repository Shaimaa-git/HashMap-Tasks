...
public class StudentHashMapKeyExistence {
    public static void main(String[] args) {
        ...
        // Student ID to check
        int studentIdToCheck = 1116;
        // Check if the specified student ID exists in the HashMap
        boolean isStudentIdPresent = studentMap.containsKey(studentIdToCheck);
        // Print the result
        System.out.println("Is student ID " + studentIdToCheck + " present in the HashMap? " + isStudentIdPresent);
