...
public class StudentHashMapRemove {
    public static void main(String[] args) {
        ...
        //create space between hashMap and Updated one
        System.out.println("\n");
        // Student ID to be removed
        int studentIdToRemove = 1112;

        // Remove the student with the specified ID from the HashMap
        studentMap.remove(studentIdToRemove);

        // Print the updated HashMap
        System.out.println("Updated Student HashMap after removing student with ID " + studentIdToRemove + ":");
        for (Map.Entry<Integer, Student> entry : studentMap.entrySet()) {
            Student student = entry.getValue();
            System.out.println("Student ID: " + student.studentId + ", Name: " + student.studentName);
        }
