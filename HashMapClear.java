...
public class StudentHashMapClear {
    public static void main(String[] args) {
        ...
        boolean isHashMapEmptyAfterClear = studentMap.isEmpty();

        // Print the result
        System.out.println("Is the HashMap empty after clearing? " + isHashMapEmptyAfterClear);
